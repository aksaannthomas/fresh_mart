...
public class Clove extends AppCompatActivity {

    Button btn_cart,btn_increment,btn_decrement;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clove);
        ...
        btn_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Clove.this, "Data inserted successfully", Toast.LENGTH_SHORT).show();
                Intent intent=new Intent(Clove.this,Cart.class);
